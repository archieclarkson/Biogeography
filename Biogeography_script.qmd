...
#plot
p<-ggplot(ps_V9_1391f_EukBr_grouped_alpha_long,aes(x=env_broad_scale,y=Diversity,colour=geo_loc_name,fill=geo_loc_name,shape=env_medium))+
  scale_colour_manual("Location",values=site_palette)+
...
ps_V9_1391f_EukBr_grouped_comp_melt<-psmelt(ps_V9_1391f_EukBr_grouped_comp)
ps_V9_1391f_EukBr_grouped_comp_melt<-prune_0(ps_V9_1391f_EukBr_grouped_comp_melt)
#Reordering
#Reordering
reordering_df<-ps_V9_1391f_EukBr_grouped_comp_melt
reordering_df$RepGroup<-fct_relevel(reordering_df$RepGroup,"Bonney_East_18","Bonney_East_22","Joyce_25","Joyce_27","Joyce_37","Vanda_63","Vanda_66","Vanda_71","CAN47","CAN61","CAN64","CAN75","CAN81","CAN87","CAN101","CAN102","CAN111","TAY18","TAY19","TAY29","TAY38","TAY40","TAY42","TAY44","COM7","COM54","COM55","COM57","COM58","COM62","COM65","COM80","COM81","DGC4","Ust4","MVCS3","MVC4","MVC5","MVC6","MVC7","LWC1","LWC2","LWC3","LWC4","LWC5","LKGC1","LKGC2","LKGC3","LKGC4","LKGC5","KSC13","KSC14","KSC16","KSC17","KSC23","KSC33","SX","SY","SZ","SvA","SvB","SvC","SvE","IM1","IM2","IM3","IM4","IC1","IC2","GrC8","GrC11","GrE8")
reordering_df$env_broad_scale<-fct_relevel(reordering_df$env_broad_scale,"Lake_Bonney_East","Lake_Joyce","Lake_Vanda","Canada_glacier","Taylor_glacier","Commonwealth_glacier","Diamond_glacier","Utsteinen_nunatak","Miers_glacier","Lower_Wright_glacier","Lower_Koettlitz_glacier","Upper_Koettlitz_glacier","Storglaciaren","Midtre_Lovenbreen_glacier","Greenland_Ice_margin_glacier","Greenland_Ice_core_glacier","Kangerlussuaq_glacier")
ps_V9_1391f_EukBr_grouped_comp_melt<-reordering_df

#colour palette
site_palette<-unname(createPalette(length(unique(reordering_df$geo_loc_name)),c("#71c9c1","#ffc385")))

#Ordination
ps_V9_1391f_EukBr_grouped_comp_ord_weighted<-ordinate(ps_V9_1391f_EukBr_grouped_comp,"NMDS","bray")
#Stress: 0.1589103
#ANOSIMs
ps_V9_1391f_EukBr_grouped_comp_site_group=get_variable(ps_V9_1391f_EukBr_grouped_comp, "env_broad_scale")
ps_V9_1391f_EukBr_grouped_comp_site_anosim=anosim(distance(ps_V9_1391f_EukBr_grouped_comp, "bray"), ps_V9_1391f_EukBr_grouped_comp_site_group)
ps_V9_1391f_EukBr_grouped_comp_site_anosim
#ANOSIM: Stress = 0.1646433, ANOSIM R-Stat 0.7351, p value = 0.001
ps_V9_1391f_EukBr_grouped_comp_loc_group=get_variable(ps_V9_1391f_EukBr_grouped_comp, "geo_loc_name")
ps_V9_1391f_EukBr_grouped_comp_loc_anosim=anosim(distance(ps_V9_1391f_EukBr_grouped_comp, "bray"), ps_V9_1391f_EukBr_grouped_comp_loc_group)
ps_V9_1391f_EukBr_grouped_comp_loc_anosim
#ANOSIM: Stress = 0.1646433, ANOSIM R-Stat 0.3808, p value = 0.001


ps_V9_1391f_EukBr_grouped_comp_dataframe<-as.data.frame(sample_data(ps_V9_1391f_EukBr_grouped_comp))
ps_V9_1391f_EukBr_grouped_comp_nmds_weighted<-plot_ordination(ps_V9_1391f_EukBr_grouped_comp,ps_V9_1391f_EukBr_grouped_comp_ord_weighted,type="samples",
                                      color="geo_loc_name",label="RepGroup",shape="env_medium")+
  ggtitle("Stress = 0.1646433, ANOSIM R-Stat 0.7351, p value = 0.001")+
  scale_colour_manual("Location",values=site_palette)+
...
ps_V9_1391f_EukBr_grouped_comp_nmds_weighted$layers
ps_V9_1391f_EukBr_grouped_comp_nmds_weighted$layers<-ps_V9_1391f_EukBr_grouped_comp_nmds_weighted$layers[-1]
ps_V9_1391f_EukBr_grouped_comp_nmds_weighted$layers<-ps_V9_1391f_EukBr_grouped_comp_nmds_weighted$layers[-1]
ps_V9_1391f_EukBr_grouped_comp_nmds_weighted
#ggsave("Plots/ps_V9_1391f_EukBr_grouped_comp_nmds_weighted.svg",width=400,height=250,units=c("mm"))
```
...
tax <- tax %>%
  mutate(
    TipLabelRaw = coalesce(Genus, Family, Order, Class, Division, Supergroup),
    TipLabel = case_when(
...
p<-ggtree(tree)%<+%tip_metadata+
  geom_tree(size=0.6)+
  geom_tiplab(aes(label=env_broad_scale,color=geo_loc_name),size=4,hjust=-0.1,fontface="bold") +
  geom_tippoint(aes(shape=env_medium,color=geo_loc_name),size=4)+
  scale_colour_manual("Location",values=site_palette) +
  scale_shape_manual("Sample media",values=c(15,16,17))+
  xlim(0,max(tree$edge.length)+0.07)+
