...
```{r}
p<-plot_richness(ps_merged_V4,measures=c("Observed","Shannon","Simpson"),x="Sample.Name",color="geo_loc_name")+
  #scale_colour_manual("Broad Location",values=site_palette_2)+
  #scale_fill_manual("Broad Location",values=site_palette_2)+
  geom_point(size=3)+
